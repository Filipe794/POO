...
def km_veiculo(veiculo):
    print(
        f'A quilometragem do {veiculo["marca"]} {veiculo["modelo"]} é {veiculo["km"]} quilometros')
...
def veiculo_maior_km():
    ...
    print(
        f'O veiculo com maior quilometragem é o {veiculo_maior["marca"]} {veiculo_maior["modelo"]} com {veiculo_maior["km"]} quilometros\n')
...
carro = Veiculo("fiat", "toro", 2003, 13414, "preto",
                "BBCCC0384", float(input("Digite a km: ")))
print(carro.marca)
codigo_viagem = 1
codigo_abastecimento = 1
codigo_manutencao = 1
